...
CREATE DATABASE IF NOT EXISTS consultationHistory DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
...
-- Sample data
INSERT INTO consultationHistory (uuid, nric, dateTime, reasonForVisit, doctorName, diagnosis, prescriptions) 
VALUES
